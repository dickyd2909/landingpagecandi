			...
			<form action="regisaction" method="post">
				<div class="loginform">
					...
					<div class="loginformbox">
						<input name="customer_nama" type="text" class="formboxlogin" required>
					</div>
				</div>
				<div class="loginform">
					<div class="loginformtit">
					...
					<div class="loginformbox">
						<input name="customer_telp" type="text" class="formboxlogin" required>
					</div>
				</div>
				<div class="loginform">
					<div class="loginformtit">
				...
				<div class="loginform">
					...
					<div class="loginformbox">
						<select name="customer_gender" class="formboxlogin" required>
